...
from kylin_ops.api import ServerError, User, Asset, PermRole, AssetGroup, get_object, mkdir, get_asset_info
from kylin_ops.api import logger, Log, TtyLog, get_role_key, CRYPTOR, bash, get_tmp_dir
from permission.perm_api import gen_resource, get_group_asset_perm, get_group_user_perm, user_have_perm, PermRole
from kylin_ops.settings import LOG_DIR, NAV_SORT_BY
from permission.ansible_api import MyRunner
#from kylin_log.log_api import escapeString
from kylin_log.models import ExecLog, FileLog
from kylin_log.views import TermLogRecorder
...
class Nav(object):
    ...
    def print_nav():
        ...
        打印提示导航
        """
        msg = """\n\033[1;32m###    欢迎使用kylin_ops开源系统   ### \033[0m
