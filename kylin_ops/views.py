...
# from permission.models import Apply
import paramiko
from kylin_ops.api import *
from kylin_ops.models import Setting
from django.contrib.auth import authenticate, login, logout
from django.contrib.auth.decorators import login_required
from kylin_log.models import Log, FileLog
from permission.perm_api import get_group_user_perm, gen_resource
from asset.models import Asset, IDC
...
def is_latest():
    ...
    lastest_version = urllib.urlopen('http://www.kylin_ops.org/lastest_version.html?jsn=%s' % jsn).read().strip()
...
def web_terminal(request):
    ...
    return render_to_response('kylin_log/web_terminal.html', locals())
