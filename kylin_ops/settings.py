"""
Django settings for kylin_ops project.
...
config.read(os.path.join(BASE_DIR, 'kylin_ops.conf'))
...
ROOT_URLCONF = 'kylin_ops.urls'

WSGI_APPLICATION = 'kylin_ops.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'kylin_ops.context_processors.name_proc',
)
...
CRONJOBS = [
    ...
    ('*/10 * * * *', 'kylin_log.log_api.kill_invalid_connection'),
]
