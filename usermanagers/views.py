...
from usermanagers.user_api import *
from permission.perm_api import get_group_user_perm
...
def group_add(request):
    ...
    return my_render('usermanagers/group_add.html', locals(), request)
...
def group_list(request):
    ...
    return my_render('usermanagers/group_list.html', locals(), request)
...
def group_edit(request):
    ...
    return my_render('usermanagers/group_edit.html', locals(), request)
...
def user_add(request):
    ...
    return my_render('usermanagers/user_add.html', locals(), request)
...
def user_list(request):
    ...
    return my_render('usermanagers/user_list.html', locals(), request)
...
def user_detail(request):
    ...
    return my_render('usermanagers/user_detail.html', locals(), request)
...
def send_mail_retry(request):
    ...
    跳板机地址： %s
    用户名：%s
    重设密码：%s/usermanagers/password/forget/
...
def forget_password(request):
    if request.method == 'POST':
        ...
        if user:
            ...
            msg = u"""
            Hi %s, 请点击下面链接重设密码！
            %s/usermanagers/password/reset/?uuid=%s&timestamp=%s&hash=%s
    ...
    return render_to_response('usermanagers/forget_password.html', locals())
...
def reset_password(request):
    ...
    action = '/usermanagers/password/reset/?uuid=%s&timestamp=%s&hash=%s' % (uuid_r, timestamp, hash_encode)
    ...
    if request.method == 'POST':
        ...
        return render_to_response('usermanagers/reset_password.html', locals())
...
def user_edit(request):
    ...
    if request.method == 'GET':
        ...
        return HttpResponseRedirect(reverse('user_list'))
    return my_render('usermanagers/user_edit.html', locals(), request)
...
def profile(request):
    ...
    return my_render('usermanagers/profile.html', locals(), request)
...
def change_info(request):
    ...
    return my_render('usermanagers/change_info.html', locals(), request)
