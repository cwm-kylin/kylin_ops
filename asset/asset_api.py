...
from asset.models import ASSET_STATUS, ASSET_TYPE, ASSET_ENV, IDC, AssetRecord
from permission.ansible_api import MyRunner
from permission.perm_api import gen_resource
from kylin_ops.templatetags.mytags import get_disk_info
