...
from permission.perm_api import get_group_asset_perm, get_group_user_perm
...
def group_add(request):
    ...
    return my_render('asset/group_add.html', locals(), request)
...
def group_edit(request):
    ...
    return my_render('asset/group_edit.html', locals(), request)
...
def group_list(request):
    ...
    return my_render('asset/group_list.html', locals(), request)
...
def asset_add(request):
    ...
    return my_render('asset/asset_add.html', locals(), request)


@require_role('admin')
def asset_add_batch(request):
    header_title, path1, path2 = u'添加资产', u'资产管理', u'批量添加'
    return my_render('asset/asset_add_batch.html', locals(), request)
...
def asset_edit(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = e.message
            return my_render('asset/asset_edit.html', locals(), request)
...
def asset_list(request):
    ...
    if export:
        ...
        return my_render('asset/asset_excel_download.html', locals(), request)
    assets_list, p, assets, page_range, current_page, show_first, show_end = pages(asset_find, request)
    if user_perm != 0:
        return my_render('asset/asset_list.html', locals(), request)
    else:
        return my_render('asset/asset_cu_list.html', locals(), request)
...
def asset_edit_batch(request):
    ...
    if request.method == 'POST':
        ...
        return my_render('asset/asset_update_status.html', locals(), request)

    return my_render('asset/asset_edit_batch.html', locals(), request)
...
def asset_detail(request):
    ...
    return my_render('asset/asset_detail.html', locals(), request)
    ...
    if request.method == 'POST':
        ...
        if idc_form.is_valid():
            ...
            if IDC.objects.filter(name=idc_name):
                ...
                return my_render('asset/idc_add.html', locals(), request)
            else:
                idc_form.save()
...
def idc_list(request):
    ...
    return my_render('asset/idc_list.html', locals(), request)
...
def idc_edit(request):
    ...
    if request.method == 'POST':
        ...
        return my_render('asset/idc_edit.html', locals(), request)
