...
from permission.perm_api import *

from usermanagers.models import User, UserGroup
from asset.models import Asset, AssetGroup
from permission.models import PermRole, PermRule, PermSudo, PermPush
from kylin_ops.models import Setting

from permission.utils import gen_keys, trans_all
from permission.ansible_api import MyTask
from permission.perm_api import get_role_info, get_role_push_host
from kylin_ops.api import my_render, get_object, CRYPTOR


# 设置PERM APP Log
from kylin_ops.api import logger
#logger = set_log(LOG_LEVEL, filename='kylin_ops_perm.log')
...
def perm_rule_list(request):
    ...
    return my_render('permission/perm_rule_list.html', locals(), request)
...
def perm_rule_detail(request):
    ...
    return my_render('permission/perm_rule_detail.html', locals(), request)
...
def perm_rule_add(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = e
    return my_render('permission/perm_rule_add.html', locals(), request)
...
def perm_rule_edit(request):
    ...
    return my_render('permission/perm_rule_edit.html', locals(), request)
...
def perm_role_list(request):
    ...
    return my_render('permission/perm_role_list.html', locals(), request)
...
def perm_role_add(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = e
    return my_render('permission/perm_role_add.html', locals(), request)
...
def perm_role_detail(request):
    ...
    return my_render('permission/perm_role_detail.html', locals(), request)
...
def perm_role_edit(request):
    ...
    sudo_all = PermSudo.objects.all()
    if request.method == "GET":
        return my_render('permission/perm_role_edit.html', locals(), request)
...
def perm_role_push(request):
    ...
    return my_render('permission/perm_role_push.html', locals(), request)
...
def perm_sudo_list(request):
    ...
    return my_render('permission/perm_sudo_list.html', locals(), request)
...
def perm_sudo_add(request):
    ...
    try:
        ...
        error = e
    return my_render('permission/perm_sudo_add.html', locals(), request)
...
def perm_sudo_edit(request):
    ...
    try:
        ...
        error = e
    return my_render('permission/perm_sudo_edit.html', locals(), request)
